...
public class VirtualNES extends Applet implements Runnable {
	...
	public void readParams() {
        ...
        Globals.controls.put("p2_up", "VK_W");
        Globals.controls.put("p2_down", "VK_S");
        Globals.controls.put("p2_left", "VK_A");
        Globals.controls.put("p2_right", "VK_D");
        Globals.controls.put("p2_a", "VK_H");
        Globals.controls.put("p2_b", "VK_J");
        Globals.controls.put("p2_start", "VK_K");
        Globals.controls.put("p2_select", "VK_L");
